...
namespace Uno.Wasm.Bootstrap
{
	internal class Constants
	{
		...
		public const string DefaultSdkUrl = @"https://unowasmbootstrap.blob.core.windows.net/runtime/mono-wasm-dd3c370ef1b.zip";
		public const string DefaultAotSDKUrl = @"https://unowasmbootstrap.blob.core.windows.net/runtime/wasm-release-Linux-dd3c370ef1bd65313abdb4062688011d5e975ef1.zip";
		...
		/// </remarks>
		public static Version EmscriptenMinVersion { get; } = new Version("1.39.20");
	}
}
