...
namespace Uno.Wasm.Bootstrap
{
	internal class Constants
	{
		...
		public const string DefaultSdkUrl = @"https://unowasmbootstrap.azureedge.net/runtime/mono-wasm-2bd6df78642.zip";
		public const string DefaultAotSDKUrl = @"https://unowasmbootstrap.azureedge.net/runtime/wasm-release-Linux-2bd6df78642122a019112d65180e34954b2e22c5.zip";
