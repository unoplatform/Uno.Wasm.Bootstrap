...
namespace Uno.Wasm.Bootstrap
{
	internal class Constants
	{
		...
		// NOTE: The SDK version may be overriden by an installation of the https://www.nuget.org/packages/Uno.Wasm.MonoRuntime nuget package
		public const string DefaultDotnetRuntimeSdkUrl = "https://unowasmbootstrap.azureedge.net/runtime/dotnet-runtime-wasm-linux-a90ef9c-df6e9560a47-793829015-Release.zip";
