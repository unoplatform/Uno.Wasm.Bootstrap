...
namespace Uno.Wasm.Bootstrap
{
	internal class Constants
	{
		...
		public const string DefaultSdkUrl = @"https://unowasmbootstrap.azureedge.net/runtime/mono-wasm-e351637985e.zip";
		public const string DefaultAotSDKUrl = @"https://unowasmbootstrap.azureedge.net/runtime/wasm-release-Linux-e351637985e65178e42ae682166323a0be01a7b3.zip";
