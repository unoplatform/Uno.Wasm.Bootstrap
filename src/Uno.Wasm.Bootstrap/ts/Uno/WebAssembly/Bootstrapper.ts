...
// Initialize Module.preRun/postRun/preInit as arrays early to support
// Emscripten preload bundles generated by --preload-file flag.
// These preload loaders expect Module.preRun to be an array and call .indexOf() on it.
(function initializeModuleArrays() {
