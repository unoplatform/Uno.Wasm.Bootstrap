...
buildSideModule(){
	mkdir -p `dirname $2`
	emcc $1 -std=c++17 -s LEGALIZE_JS_FFI=0 -r -o $2 -s WASM=1 -s USE_LIBPNG=1 -s DISABLE_EXCEPTION_CATCHING=0 -DCUSTOM_VERSION="\"$3\"" -DCUSTOM_FUNCTION_NAME="$4_getCustomVersion"
}
